...
class SlidingWindowDrive():
    ...
    def _sliding_window_drive(self, frame):
        ...
        if ret_left and ret_right:
            ...
            steering_angle = self.filter_deg.prev_lpf + 8
    ...
    def get_motor_info(self, frame):
        motor_angle, linear_func_left, linear_func_right = self._sliding_window_drive(frame)
        ...
        return MotorInfo(angle, speed), linear_func_left, linear_func_right
